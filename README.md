...
* [Vruzend DIY Battery Pack System](http://vruzend.com/), with [upcoming higher current V2](http://vruzend.com/progress-report-on-the-v2-high-current-kits/) Note: the current kit is rated at 3.5A which at 48V produces only 168W and therefore falls short of the 250-750W of the Bafang Mid-drive motors.
